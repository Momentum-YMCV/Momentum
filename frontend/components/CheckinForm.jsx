      ...
      <div id='checkin-form-container'>
        {showForm ? (
          <form id='checkin-form' onSubmit={handleSubmit}>
            <h2 id='checkin-title' className='checkinTitle'>
              Today's Check-in
            </h2>
          ...
          <div id='ai-plan-response'>
            <h2 id='response-title'>Your Personalized Plan</h2>
            <p id='ai-plan-text'>{AiPlan}</p>
            <button id='new-checkin-button' onClick={handleNewCheckin}>
              New Check-in
            </button>
          </div>
        )}
        ...
        {isLoading && (
          <div id='loading-spinner'>
            ...
            <p id='loading-text'>Creating your personalized plan...</p>
          </div>
        )}
      </div>
    </div>
